...
# Copy the ARM library to a temporary location
mkdir $RESULT_DIR
cp .libs/libfftw3.a $RESULT_DIR/libfftw3_arm64.a
...
lipo -arch armv7 $RESULT_DIR/libfftw3_armv7.a -arch arm64 $RESULT_DIR/libfftw3_arm64.a -arch i386 $RESULT_DIR/libfftw3_i386.a -arch x86_64 $RESULT_DIR/libfftw3_x86_64.a -create -output $RESULT_DIR/libfftw3_double.a
